...
**[naturalbrakemansoar/discord-fix](https://github.com/naturalbrakemansoar/discord-fix)** — сборка для Windows 10/11

[**⬇ Скачать последний релиз**](https://github.com/naturalbrakemansoar/discord-fix/releases/latest)
...
> Если вы наткнулись на что-то вне репозитория `naturalbrakemansoar/discord-fix`, что распространяется от моего лица — **ФЕЙК**.
...
1. Откройте [**Releases → Latest**](https://github.com/naturalbrakemansoar/discord-fix/releases/latest) и скачайте **`.rar`** (предпочтительно)
